...
@Component({
  selector: 'app-internshipapplication',
  templateUrl: './internshipapplication.component.html',
  styleUrl: './internshipapplication.component.css'
})
export class InternshipapplicationComponent {
   id!: number;
    ...
    ngOnInit(): void {
      ...
      this.initForm();
      this.loadInternshipQuestions();
    }

    fetchInternship(): void {
      this.studentService.getInternshipById(this.id).subscribe({
        next: data => {
          this.internship = data;
          console.log('Internship fetched successfully', data);
        },
  ...
  loadInternshipQuestions(): void {
      this.studentService.getApplicationQuestionsByInternshipId(this.id).subscribe({
        next: questions => {
          console.log('Internship questions loaded successfully', questions);
  ...
  // Submit
  this.studentService.applyForInternship(this.id, formData).subscribe({
    next: (response) => {
